...
await message.guild.channels.cache.find(a => a.name === "?︲Chat").send(' <@'+message.author.id+"> **Sunucunuz Başarıyla Kuruldu** Anime Bot Her Zaman En İyisi")
}
 
exports.conf = {
enabled: true,
guildOnly: false,
aliases: ['publicsunucu-kur'],
permLevel: 0
};
